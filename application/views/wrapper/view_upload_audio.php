<div id="page-wrapper" >
            ...
            <!-- Row de Titulos -->
              ...
              <hr />  
                ...
                <div class="panel-heading">Subir Nuevo Archivo de Audio</div>
                <div class="panel-body">
                ...
                <strong>Seleccione un documento en formato mp3</strong>
                </div>
                    <div class="drag-drop" style="alignment-adjust: baseline;">
            <input type="file" id="fileUploadAudio" required="required" accept="audio/mp3"/>
            <span class="fa-stack fa-2x">
                <i class="fa fa-cloud fa-stack-2x bottom pulsating"></i>
                <i class="fa fa-circle fa-stack-1x top medium"></i>
                <i class="fa fa-arrow-circle-up fa-stack-1x top"></i>
            </span>
            <span class="desc">Pulse aqu&iacute; para subir un Archivo</span>
                </div>
                <br />
                <div id="document-holder" align="center">
                    ...
                    <br/>
                    <div class="alert alert-success">
                <strong>Seleccione una imagen para la previsualizacion del archivo</strong>
                </div>
                    <div class="drag-drop" style="alignment-adjust: baseline;">
