<div id="page-wrapper" >
            ...
            <!-- Row de Titulos -->
              ...
              <hr />  
                ...
                <div class="panel-body">
                <form class="formulario" enctype="multipart/form-data" id="uploader">
            ...
            <input type="file" id="fileUpload" required="required" accept="video/*"/>
            <span class="fa-stack fa-2x">
                <i class="fa fa-cloud fa-stack-2x bottom pulsating"></i>
                <i class="fa fa-circle fa-stack-1x top medium"></i>
                <i class="fa fa-arrow-circle-up fa-stack-1x top"></i>
            </span>
            <span class="desc">Pulse aqu&iacute; para subir un Video</span>
                </div>
                <br />
