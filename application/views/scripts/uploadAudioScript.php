...
function uploadFile(){
	...
	ajax.open("POST", "<?=base_url()?>upload/audio");
	ajax.send(formdata);
    }
    else{
        finish();
...
function completeHandler(event){
    ...
    window.location.href = "<?=base_url()?>" +"admin/finalizado/"+id+"/audio";
}
